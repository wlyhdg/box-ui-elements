export default {
  ...
  "boxui.unifiedShare.contactRestrictionNotice": "Det går inte att skicka inbjudningar till {count, plural, one {{count} person} other {{count} personer}} eftersom externt samarbete är begränsat på grund av den tillämpade klassificeringen.",
  "boxui.unifiedShare.contactRestrictionNoticeSingular": "Det går inte att skicka inbjudningar till {email} eftersom externt samarbete är begränsat på grund av den tillämpade klassificeringen.",
  ...
  "boxui.unifiedShare.justifiableContactRestrictionNotice": "För det här sekretessbelagda innehållet krävs en affärsmotivering för att kunna skicka inbjudan till {count, plural, one {{count} person} other {{count} personer}}. Välj en affärsmotivering nedan.",
  "boxui.unifiedShare.justifiableContactRestrictionNoticeSingular": "För det här sekretessbelagda innehållet krävs en affärsmotivering för att kunna skicka inbjudan till {email}. Välj en affärsmotivering nedan.",
