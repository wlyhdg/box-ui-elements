export default {
  ...
  "boxui.unifiedShare.contactRestrictionNotice": "Invitations cannot be sent to {count, plural, one {{count} person} other {{count} people}} because external collaboration is restricted due to the applied classification.",
  ...
  "boxui.unifiedShare.justifiableContactRestrictionNotice": "This classified content requires a business justification to invite {count, plural, one {{count} person} other {{count} people}}. Please select a business justification below.",
