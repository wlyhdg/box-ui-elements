export default {
  ...
  "boxui.unifiedShare.contactRestrictionNotice": "Einladungen können nicht an {count, plural, one {{count} Person} other {{count} Personen}} gesendet werden, da die externe Zusammenarbeit aufgrund der angewendeten Klassifizierung eingeschränkt ist.",
  "boxui.unifiedShare.contactRestrictionNoticeSingular": "Einladungen können nicht an {email} gesendet werden, da die externe Zusammenarbeit aufgrund der angewendeten Klassifizierung eingeschränkt ist.",
  ...
  "boxui.unifiedShare.justifiableContactRestrictionNotice": "Für diesen klassifizierten Inhalt ist eine Geschäftsbegründung erforderlich, wenn Sie {count, plural, one {{count} Person} other {{count} Personen}} einladen möchten. Wählen Sie unten eine Geschäftsbegründung aus.",
  "boxui.unifiedShare.justifiableContactRestrictionNoticeSingular": "Für diesen klassifizierten Inhalt ist eine Geschäftsbegründung erforderlich, wenn Sie {email} einladen möchten. Wählen Sie unten eine Geschäftsbegründung aus.",
