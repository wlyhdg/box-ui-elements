export default {
  ...
  "boxui.unifiedShare.contactRestrictionNotice": "Invitasjoner kan ikke sendes til {count, plural, one {{count} person} other {{count} personer}} fordi det eksterne samarbeidet er begrenset på grunn av den anvendte klassifiseringen.",
  "boxui.unifiedShare.contactRestrictionNoticeSingular": "Invitasjoner kan ikke sendes til {email} fordi det eksterne samarbeidet er begrenset på grunn av den anvendte klassifiseringen.",
  ...
  "boxui.unifiedShare.justifiableContactRestrictionNotice": "Dette klassifiserte innholdet krever en forretningsbegrunnelse for å invitere {count, plural, one {{count} person} other {{count} personer}}. Velg en forretningsbegrunnelse nedenfor.",
  "boxui.unifiedShare.justifiableContactRestrictionNoticeSingular": "Dette klassifiserte innholdet krever en forretningsbegrunnelse for å invitere {email}. Velg en forretningsbegrunnelse nedenfor.",
