export default {
  ...
  "boxui.unifiedShare.contactRestrictionNotice": "Invitationer kan ikke sendes til {count, plural, one {{count} person} other {{count} personer}}, fordi eksternt samarbejde er begrænset på grund af den anvendte klassificering.",
  "boxui.unifiedShare.contactRestrictionNoticeSingular": "Invitationer kan ikke sendes til {email}, fordi eksternt samarbejde er begrænset på grund af den anvendte klassificering.",
  ...
  "boxui.unifiedShare.justifiableContactRestrictionNotice": "Dette klassificerede indhold kræver en forretningsbegrundelse for at invitere {count, plural, one {{count} person} other {{count} personer}}. Vælg en forretningsbegrundelse nedenfor.",
  "boxui.unifiedShare.justifiableContactRestrictionNoticeSingular": "Dette klassificerede indhold kræver en forretningsbegrundelse for at invitere {email}. Vælg en forretningsbegrundelse nedenfor.",
